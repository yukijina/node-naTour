...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoieXVraWppbmEiLCJhIjoiY2trcmUzYjRiMHFoNDJ5bzV4NGh5ZWpxaCJ9.TSJF0Dlz5Naqly5-oOCD2w';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // Add popip
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Error logged out. Try again.');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            console.log(_context.t0); //showAlert('error', error.response.data.message);
...
var stripe = Stripe('pk_test_BUxxxxx-xxxxxxxxxxxxxx');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log('session==>', session); // 2) Create checkout for + share credit card
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            // after await is resolved, empty value
